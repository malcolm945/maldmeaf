...
public class EntityPlayerSP extends AbstractClientPlayer
{
    ...
    public void onUpdate()
    {
        ...
        {
        	EventPlayerUpdate eventPlayerUpdate = new EventPlayerUpdate(this.rotationYaw, this.rotationPitch, this.posX, this.posY, this.posZ, this.onGround);
        	EventManager.call(eventPlayerUpdate);
        	super.onUpdate();
    ...
    public void onUpdateWalkingPlayer() {
        ...
        if (this.isCurrentViewEntity()) {
            ...
            EventPostMotion post2 = new EventPostMotion();
    ...
    public void onLivingUpdate()
    {
        ...
        if (this.isUsingItem() && !this.isRiding()&&!ModManager.getModByName("NoSlowDown").isEnabled()) {
