...
import cn.Judgment.ui.Login.GuiLogin;
import cn.Judgment.util.HWID;
...
public class Minecraft implements IThreadListener, IPlayerUsage
{
    ...
    private static final ResourceLocation locationMojangPng = new ResourceLocation("textures/gui/title/Kyra.png");
  ...
  //ɱ¾�ֶ�//
    ...
    public void run()
    {
        this.running = true;
        try {
			if (!Client.sendGet("https://gitee.com/WorstClient/codes/iqpzhe3f6rxytmak29vob37/raw?blob_name=Worstbanben").contains(Client.CLIENT_Bulid)) {
			            JOptionPane.showMessageDialog(null, "\u8bf7\u53bb\u552e\u540e\u7fa4\u83b7\u53d6\u6700\u65b0\u7248", "\u9519\u8bef", (int)0);
			            Runtime.getRuntime().exit(new Random().nextInt(123123));
			        }
		} catch (HeadlessException | IOException e) {
		 	JOptionPane.showMessageDialog(null,"锟斤拷锟斤拷锟斤拷锟�", "锟斤拷锟斤拷",JOptionPane.ERROR_MESSAGE);
	    	e.printStackTrace();
    ...
    private void createDisplay() throws LWJGLException
    {
        ...
        Display.setTitle("Minecraft 1.8.8 | "+Client.CLIENT_name +"v" +Client.CLIENT_VER);
    ...
    private void setWindowIcon()
    {
        ...
        if (util$enumos != Util.EnumOS.OSX)
        {
            ...
            try
            {
            	inputstream = this.mcDefaultResourcePack.getInputStream(new ResourceLocation("Client/icons/16x16.png"));
				inputstream1 = this.mcDefaultResourcePack.getInputStream(new ResourceLocation("Client/icons/32x32.png"));
	...
	public static String getHimName(String text, String left, String right) {
		String result = "";
		int zLen;
