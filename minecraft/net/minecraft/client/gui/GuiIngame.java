...
public class GuiIngame extends Gui
{
    ...
    protected void renderTooltip(ScaledResolution sr, float partialTicks){
    	if(ModManager.getModByName("HUD").isEnabled() && HUD.hotbar.getValueState().booleanValue()) {
			RenderUtil.drawRect(sr.getScaledWidth() / 2 - 480, sr.getScaledHeight() - 23, sr.getScaledWidth() / 2 + 480, sr.getScaledHeight(), Integer.MIN_VALUE);
		   	if(mc.thePlayer.inventory.currentItem == 0) {
		   		RenderUtil.drawRect(sr.getScaledWidth() / 2 - 91, sr.getScaledHeight() - 23, (sr.getScaledWidth() / 2 + 91) - 20 * 8, sr.getScaledHeight(), Integer.MAX_VALUE);
		   	} else {
		   		RenderUtil.drawRect((sr.getScaledWidth() / 2) - 91 + mc.thePlayer.inventory.currentItem * 20, sr.getScaledHeight() - 23, (sr.getScaledWidth() / 2) + 91 - 20 * (8 - mc.thePlayer.inventory.currentItem), sr.getScaledHeight(), Integer.MAX_VALUE);
		   	}
		   	GlStateManager.disableBlend();
		}
    ...
    private void renderScoreboard(ScoreObjective p_180475_1_, ScaledResolution p_180475_2_) {
        ...
        for (Object score1 : arraylist1) {
            ...
            Client.playingGame = s3.replaceAll("\u00a7.", "");
        }
    }
