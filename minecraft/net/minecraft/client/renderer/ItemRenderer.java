...
public class ItemRenderer
{
    ...
    private void func_178105_d(float p_178105_1_) {
    	if(ModManager.getModByName("Animation").isEnabled() && Animation.sanimation.getValueState().booleanValue()) {
        ...
        if (this.itemToRender != null)
        {
            ...
            else if (entityplayersp.getItemInUseCount() > 0)
            {
                ...
                switch (enumaction)
                {
                    ...
                    case BLOCK:
                    	if(!ModManager.getModByName("Animation").isEnabled() )  {
                    		this.transformFirstPersonItem(f, 0.0F);
                            this.func_178103_d();
                            float var14 = MathHelper.sin(f1 * f1 * 3.1415927F);
                            float var15 = MathHelper.sin(MathHelper.sqrt_float(f1) * 3.0F);
                            GlStateManager.translate(0.0F, -0.0F, 0.0F);
                            GlStateManager.rotate(-var15 * 0.0F, 0.0F, 0.0F, 0.0F);
                            GlStateManager.rotate(-var15 * 0.0F, 5.0F, 0.0F, 0.0F);
                    	}
                    	if(ModManager.getModByName("Animation").isEnabled() )  {
                        if( Animation.mode.isCurrentMode("None")) {
                    		this.transformFirstPersonItem(f, 0.0F);
                            this.func_178103_d();
                            float var14 = MathHelper.sin(f1 * f1 * 3.1415927F);
                            float var15 = MathHelper.sin(MathHelper.sqrt_float(f1) * 3.0F);
                            ...
                            GlStateManager.rotate(-var15 * 0.0F, 0.0F, 0.0F, 0.0F);
                            GlStateManager.rotate(-var15 * 0.0F, 5.0F, 0.0F, 0.0F);
                    	} else if(Animation.mode.isCurrentMode("Push")) {
                    		this.transformFirstPersonItem(f, 0.0F);
                            this.func_178103_d();
                            float var14 = MathHelper.sin(f1 * f1 * 3.1415927F);
                            float var15 = MathHelper.sin(MathHelper.sqrt_float(f1) * 3.0F);
                    	...
                    	} else if(Animation.mode.isCurrentMode("BLC")) {
                    		transformFirstPersonItem(f, 8.0F);
                            func_178103_d();
                            float var14 = MathHelper.sin(f1 * f1 * 3.1415927F);
                            float var15 = MathHelper.sin(MathHelper.sqrt_float(f1) * 3.1415927F);
                            GlStateManager.scale(0.4F, 0.4F, 0.1F);
                            GlStateManager.translate(-1.4F, 0.1F, 9.0F);
                            GlStateManager.rotate(-var15 * 20.0F, -5.0F, -5.0F, 9.0F);
                    	} else if(Animation.mode.isCurrentMode("BLC2")) {
                    		transformFirstPersonItem(f, 8.0F);
                            func_178103_d();
                            float var14 = MathHelper.sin(f1 * f1 * 3.1415927F);
                            float var15 = MathHelper.sin(MathHelper.sqrt_float(f1) * 3.1415927F);
                            GlStateManager.scale(0.4F, 0.4F, 0.1F);
                            GlStateManager.translate(-2.0F, 0.1F, -5.0F);
                            GlStateManager.rotate(-var15 * 20.0F, -5.0F, -5.0F, 9.0F);
                            ...
                            GlStateManager.rotate(-var15 * ((float) 60D / 2.0F), -5.0F, 0.0F, 9.0F); 
                    	...
                    	} else if(Animation.mode.isCurrentMode("Winter")) {
                            this.x3IsBlack(-0.30f, f1);
                            this.func_178103_d();
                            break;
                    	 
                 	  } else if(Animation.mode.isCurrentMode("Luna")) {
                	         this.transformFirstPersonItem(f1, 0.0F);
                	         this.func_178103_d();
                	         float var14  = MathHelper.sin(f1 * f1 * 3.1415927F);
                	         float var15 = MathHelper.sin(MathHelper.sqrt_float(f1) * 3.1415927F);
                	         GlStateManager.scale(1.0F, 1.0F, 1.0F);
