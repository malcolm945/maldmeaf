...
public class RenderItem implements IResourceManagerReloadListener
{
    ...
    private void renderEffect(IBakedModel model)
    {
      ...
      if(ModManager.getModByName("EnchantEffect").isEnabled() ) {
        ...
        this.renderModel(model, new Color(EnchantEffect.r.getValueState().intValue(), EnchantEffect.g.getValueState().intValue(), EnchantEffect.b.getValueState().intValue()).getRGB());
        GlStateManager.popMatrix();
        GlStateManager.pushMatrix();
        GlStateManager.scale(8.0F, 8.0F, 8.0F);
