...
public class Block
{
    ...
    public boolean shouldSideBeRendered(IBlockAccess worldIn, BlockPos pos, EnumFacing side) {
  		if (Helper.xray && Helper.containsID(getIdFromBlock(this))) {
  			if(!Helper.bypass)
  				return true;
    ...
    {
    	if (Helper.xray) {
           return Helper.containsID(getIdFromBlock(this)) ? EnumWorldBlockLayer.SOLID : EnumWorldBlockLayer.TRANSLUCENT;
        } else {
