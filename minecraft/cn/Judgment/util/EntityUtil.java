...
public class EntityUtil {
    ...
    public static Entity findClosestToCross(double range) {
	    ...
	    for (Object o : Minecraft.getMinecraft().theWorld.loadedEntityList) {
	    	...
	    	double difference = Math.abs(angleDifference(newYaw, Minecraft.getMinecraft().thePlayer.rotationYaw));
		 	if (ent != Minecraft.getMinecraft().thePlayer && Minecraft.getMinecraft().thePlayer.getDistanceToEntity(ent) <= range && ent instanceof EntityPlayer) {
		 		if (difference < best) {
		 			best = difference;
			 		e = ent;
			 	}
    ...
    public static boolean isValid(boolean animals, boolean players, boolean invisibles, Entity e) {
        boolean state = false;
        if (!(!isMob(e) || isPlayer(e) || isAnimal(e) || isItem(e) || isProjectile(e) || isFalling(e) || isInvisible(e))) {
            state = false;
        }
        if (!(!animals || !isAnimal(e) || isMob(e) || isPlayer(e) || isItem(e) || isProjectile(e) || isFalling(e) || isInvisible(e))) {
            state = true;
        }
        if (!(!players || !isPlayer(e) || isMob(e) || isAnimal(e) || isItem(e) || isProjectile(e) || isFalling(e) || isInvisible(e))) {
            state = true;
        }
        if (!(!isProjectile(e) || isMob(e) || isAnimal(e) || isPlayer(e) || isItem(e) || isFalling(e) || isInvisible(e))) {
            state = false;
        }
