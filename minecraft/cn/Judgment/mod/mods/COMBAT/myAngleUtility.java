...
class myAngleUtility {
    ...
    public static double isInFov(float var0, float var1, double var2, double var4, double var6) {
        Vec3 var8 = new Vec3(var0, var1, 0.0);
    ...
    public static float[] getAngles(Entity entity) {
        ...
        float var9 = (float)(Math.atan2(var3, var1) * 180.0 / Math.PI) - 90.0f;
        float var10 = (float)(-(Math.atan2(var5, var11) * 180.0 / Math.PI));
    ...
    public static boolean isValidToRotate(double var0, double var2) {
        if (Minecraft.thePlayer != null && Minecraft.theWorld != null && Minecraft.thePlayer.getEntityWorld() != null) {
            Entity var5;
            Iterator<Entity> var4 = Minecraft.thePlayer.getEntityWorld().loadedEntityList.iterator();
            do {
                if (var4.hasNext()) continue;
                return false;
            } while (!((var5 = var4.next()) instanceof EntityPlayer) || var5 == Minecraft.thePlayer || (double)Minecraft.thePlayer.getDistanceToEntity(var5) >= var0 || myAngleUtility.isInFov(Minecraft.thePlayer.rotationYaw, Minecraft.thePlayer.rotationPitch, var5.posX, var5.posY, var5.posZ) >= var2);
            return true;
        }
        return false;
    }
    ...
    public static double normalizeAngle(double var0, double var2) {
        double var4 = Math.abs(var0 % 360.0 - var2 % 360.0);
        var4 = Math.min(360.0 - var4, var4);
        return Math.abs(var4);
    }

    private double getAngleYaw(EntityLivingBase var1) {
        return myAngleUtility.getAnglesIgnoringNull(var1, Minecraft.thePlayer.rotationYaw, Minecraft.thePlayer.rotationPitch)[0];
    }
}
